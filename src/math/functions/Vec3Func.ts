 ...
 * @returns {vec3} out
 */
export function rotateX(out: Vec3, a: Vec3, b: Vec3, c: number) {
    let p = [], r = [];
 ...
 * @returns {vec3} out
 */
export function rotateY(out: Vec3, a: Vec3, b: Vec3, c: number) {
    let p = [], r = [];
    //Translate point to the origin
    p[0] = a[0] - b[0];
    p[1] = a[1] - b[1];
 ...
 * @returns {vec3} out
 */
export function rotateZ(out: Vec3, a: Vec3, b: Vec3, c: number) {
    let p = [], r = [];
    //Translate point to the origin
    p[0] = a[0] - b[0];
    p[1] = a[1] - b[1];
